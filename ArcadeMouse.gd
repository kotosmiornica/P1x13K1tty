...
#	if center_node:
#		var offset = global_position - center_node.global_position
#		if offset.length() > max_distance:
#			global_position = center_node.global_position + offset.normalized() * max_distance
#
#	Global.virtual_cursor_pos = global_position
